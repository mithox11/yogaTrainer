...
export interface RoutineFramework {
  pranayama: string;
  warmupAndSunSalutations: string;
  mainSequenceFocus: string;
  cooldownAndSavasana: string;
}
...
export interface Routine {
  ...
  posesSequence?: PoseSequenceItem[];
}
